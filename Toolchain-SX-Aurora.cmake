...
ENDIF()
IF(DEFINED $ENV{NMPI_ROOT})
  SET(MPI_DIR $ENV{NMPI_ROOT})
ELSE()
  SET(MPI_DIR /opt/nec/ve/mpi/3.2.0)
ENDIF()
# specify the cross compilers
SET(CMAKE_C_COMPILER ncc CACHE FILEPATH "NEC VE C compiler")
SET(CMAKE_CXX_COMPILER nc++ CACHE FILEPATH "NEC VE C++ compiler")
SET(CMAKE_Fortran_COMPILER nfort CACHE FILEPATH "NEC VE Fortran compiler")
...
SET(MPI_C_COMPILER ${MPI_DIR}/bin/mpincc CACHE FILEPATH "NEC VE MPI C compiler")
SET(MPI_CXX_COMPILER ${MPI_DIR}/bin/mpinc++ CACHE FILEPATH "NEC VE MPI C++ compiler")
SET(MPI_Fortran_COMPILER ${MPI_DIR}/bin/mpinfort CACHE FILEPATH "NEC VE MPI Fortran compiler")
